  ...
  return (
    <LegalLayout eyebrow="Guide" title="배송 · 교환/환불 안내" updated="2026-05-30">
      ...
      <Article heading="배송">
        ...
        <p>정기구독은 선택하신 요일(월–금 중 하나)에 맞추어 매주 1회 반복 배송됩니다. 구독 기간(1·3·6·12개월)분을 한 번에 입금하시면 해당 기간 동안 매주 배송됩니다.</p>
        <p>정기구독 배송비는 회당 4,000원이며, 선택하신 기간 전체 회차분이 입금액에 포함됩니다. 회당 상품 금액(할인 전 정가 기준)이 50,000원 이상이면 배송비는 무료입니다. 회당 최소 상품 금액은 20,000원입니다.</p>
