  ...
  return (
    <LegalLayout eyebrow="Guide" title="배송 · 교환/환불 안내" updated="2026-05-30">
      ...
      <Article heading="배송">
        ...
        <p>정기구독은 선택하신 요일(월–금 중 하나)에 맞추어 매주 1회 반복 발송됩니다. 구독 기간은 4주·8주·12주 중에서 선택하실 수 있으며, 선택하신 기간(4·8·12회)분을 한 번에 입금하시면 그 기간 동안 매주 발송됩니다. 기간이 길수록 할인이 커집니다 — 4주 10%, 8주 12%, 12주 15%. 만료 전 연장(재입금)하시면 이어서 받으실 수 있습니다.</p>
        <p>정기구독 배송비는 회당 4,000원이며, 선택하신 기간의 전체 회차분이 입금액에 포함됩니다. 배송비는 주문 금액과 관계없이 모두 자부담입니다. 회당 최소 상품 금액은 24,000원입니다.</p>
