  ...
  return (
    <LegalLayout eyebrow="Guide" title="배송 · 교환/환불 안내" updated="2026-05-30">
      ...
      <Article heading="배송">
        ...
        <p>정기구독은 선택하신 요일(월–금 중 하나)에 맞추어 매주 1회 반복 배송됩니다. 구독 기간은 1개월 고정으로, 1개월(4회)분을 한 번에 입금하시면 4주 동안 매주 배송됩니다. 다음 달도 받으시려면 만료 전 연장(재입금)해 주시면 됩니다.</p>
        <p>정기구독 배송비는 회당 4,000원이며, 1개월(4회) 전체 회차분이 입금액에 포함됩니다. 배송비는 주문 금액과 관계없이 모두 자부담입니다. 회당 최소 상품 금액은 25,000원입니다.</p>
