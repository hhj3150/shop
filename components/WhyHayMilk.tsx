...
const NOTES = [
  {
    k: "A2 / A2",
    t: "저지, 그리고 A2 단백질",
    d: "대한민국 0.01%에 불과한 A2/A2 저지소의 원유만을 씁니다. A2 베타카세인은 단백질 사슬의 67번 자리에 프롤린이 있어, 소화 과정에서 일부 사람이 불편을 느끼게 한다고 알려진 펩타이드(BCM-7)를 거의 만들지 않습니다. 그래서 우유를 마신 뒤 속이 한결 편안하다고 느끼는 분이 많습니다.",
  },
  {
    k: "Hay-fed",
    t: "사일리지 없이, 풀과 건초만",
