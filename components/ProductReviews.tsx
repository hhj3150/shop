    ...
    <section className="mx-auto max-w-3xl px-5 py-20 sm:px-8">
      ...
      <ul className="mt-8 divide-y divide-line border-t border-line">
        {loaded && reviews.length === 0 && (
          <li className="py-12">
            <EmptyState
              icon={<path d="M12 4l2.3 4.9 5.2.7-3.8 3.6.9 5.2L12 16.6 7.4 18.4l.9-5.2-3.8-3.6 5.2-.7L12 4Z" strokeLinejoin="round" />}
              title="첫 한 병의 후기를 기다립니다"
              description="받아보신 솔직한 한 마디가 다음 한 분의 선택에 큰 힘이 됩니다."
            />
          </li>
        )}
        {reviews.map((r) => (
