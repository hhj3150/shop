...
const STEPS = [
  ...
  },
  {
    n: "02",
    t: "기간만큼, 한 번에",
    d: "선택하신 기간분(매주 한 병 × 4·8·12주)을 무통장으로 한 번 입금해 주시면, 확인되는 즉시 첫 병을 준비합니다. 매번의 결제 없이 약속한 요일마다 채워 드립니다.",
  },
  {
    n: "03",
    t: "창립 500인의 특권",
    d: "선착순 창립 500인 회원께만 드리는 특권 — 기간이 길수록 커지는 회원가(10–15%)로 모십니다. 원하시는 기간만큼 가볍게, 부담 없이 이어집니다.",
  },
];
