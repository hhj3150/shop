...
describe("formatPhoneKR", () => {
  ...
  it("국가번호(82)를 0으로 정규화해 끝자리가 잘리지 않는다", () => {
    // 82106205315 0 (12자리)를 그냥 자르면 끝 0이 사라진다 → 82를 0으로 먼저 치환.
    expect(formatPhoneKR("821062053150")).toBe("010-6205-3150");
    expect(formatPhoneKR("+82 10-6205-3150")).toBe("010-6205-3150");
    expect(formatPhoneKR("+821012345678")).toBe("010-1234-5678");
  });
});
