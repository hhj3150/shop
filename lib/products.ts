...
// 회원 할인율 10%. 다음 달도 받으시려면 매월 연장(재입금)한다.
...
// 구독 기간(개월). 1개월 고정.
export type SubPeriod = 1;
export const SUB_PERIODS: SubPeriod[] = [1];
...
// 회원 기본 할인(1개월 고정 10%). 가격 표기/병당 회원가 계산의 기본값.
